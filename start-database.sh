...
DB_CONTAINER_NAME="cs2-skin-notif-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=cs2-skin-notif -d -p 3306:3306 docker.io/mysql
